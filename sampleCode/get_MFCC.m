function mfcc = get_MFCC(snd,Fs, params)

if isempty(params.numFilt)
    params.numFilt=floor(3*log(Fs));
end
[mfcc,~]=melcepst(snd,Fs,'MtdD',params.numCeps,...
    params.numFilt,floor(params.WINsec*Fs),floor(params.STEPsec*Fs),0,0.5);
        
end

%%
% -------
% MFCC from VoiceBox toolbox
% -------
