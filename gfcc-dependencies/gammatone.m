function [r, cf] = gammatoneFast(in, numChan, fRange, fs)
...
if nargin < 2
    numChan = 64;       % default number of filter channels in filterbank
end
if nargin < 3
    fRange = [50, 4000]; % default frequency range in Hz
end
if nargin < 4
